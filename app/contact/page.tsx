  ...
  return (
    <div className="min-h-screen relative" style={{backgroundColor: 'var(--color-light)'}}>
      ...
      <div className="container-custom py-16 max-w-3xl relative z-10">
        <p className="text-base leading-relaxed mb-16 border-l-2 pl-6" style={{borderColor: 'var(--color-accent-blue)', color: 'var(--color-dark)'}}>
          Let's talk about your brand, your goals, and how I can help bring them to life.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="border p-8 rounded-lg group relative transition-all duration-300 hover:-translate-y-1 hover:shadow-md" style={{backgroundColor: 'rgba(26, 35, 50, 0.02)', borderColor: 'rgba(26, 35, 50, 0.1)'}}>
        ...
        <div className="border p-12 rounded-lg group relative transition-all duration-300 hover:-translate-y-1 hover:shadow-md" style={{backgroundColor: 'rgba(26, 35, 50, 0.02)', borderColor: 'rgba(26, 35, 50, 0.1)'}}>
          ...
          <form className="space-y-8">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full px-4 py-3 border rounded transition-all duration-300 focus:outline-none focus:-translate-y-1"
                style={{backgroundColor: 'var(--color-light)', borderColor: 'rgba(26, 35, 50, 0.1)', color: 'var(--color-dark)'}}
